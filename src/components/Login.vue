        ...
        <div class="login-content">
          ...
          <el-form>
            <el-form-item>
              ...
              <div class="verify-tip verify-bottom" v-show='verifyTip.userError'>
                <div class="verify-tip-arrow"></div>
                <div class="verify-tip-inner">{{verifyTip.userErrorInfo}}</div>
              </div>
            </el-form-item>
            <el-form-item>
              ...
              <div class="verify-tip verify-bottom" v-show='verifyTip.passError'>
                <div class="verify-tip-arrow"></div>
                <div class="verify-tip-inner">{{verifyTip.passErrorInfo}}</div>
              </div>
            </el-form-item>
            <div class="check-box">
              <el-form-item>
                ...
                <div class="verify-tip verify-bottom" v-show='verifyTip.codeError'>
                  <div class="verify-tip-arrow"></div>
                  <div class="verify-tip-inner">{{verifyTip.codeErrorInfo}}</div>
                </div>
              </el-form-item>
              <div class="checkCode">
                <canvas id="codeImg"
...
<script>
  ...
  export default {
    ...
    watch: {
      loginForm: {
        handler() {
          this.verifyTip.userError = false
          this.verifyTip.userErrorInfo = ''
          this.verifyTip.passError = false
          this.verifyTip.passErrorInfo = ''
          this.verifyTip.codeError = false
          this.verifyTip.codeErrorInfo = ''
        },
        deep: true
      }
    },
    methods: {
      ...
      nameBlur() {
        if (this.loginForm.username === /** @type {boolean} */ '') {
          this.verifyTip.userErrorInfo = '用户名不能为空'
          this.verifyTip.userError = true
        }
      }
    }
  }
