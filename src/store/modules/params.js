const params = {
  state: {
    ...
    // 用户
    userParams: JSON.parse(window.sessionStorage.getItem('userParams'))
  },
  mutations: {
    // 客户
  ...
  actions: {
    ...
    // 用户
    userParams({ commit }, params) {
      window.sessionStorage.setItem('userParams', JSON.stringify(params))
      commit('USER_PARAMS', params)
    }
  }
}
