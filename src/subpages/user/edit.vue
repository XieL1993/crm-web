<template>
  <transition name="dialog-fade">
    <div id="mask-user-edit" :class="{hideSidebar:!sidebar.opened}">
      <div class="dialog">
        <div class="header">
          <h3>编辑用户信息</h3>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="登陆名" prop="userName">
                  <el-input clearable placeholder="请输入" v-model="formItems.userName" disabled></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
...
<script>
  ...
  export default {
    ...
    methods: {
      fetchData() {
        return updateUser(this.userId, this.getParams())
      },
      fetchDetail() {
