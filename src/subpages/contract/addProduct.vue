<template>
  <transition name="dialog-fade">
    <div id="mask-contract-product-add" :class="{hideSidebar:!sidebar.opened}">
      <div class="dialog">
        <div class="header">
          <h3>新增合同产品</h3>
...
<script>
  ...
  import { addContractProduct } from '../../api/contract'
  ...
  export default {
    ...
    methods: {
      fetchData() {
        return addContractProduct(this.getParams())
      }
    },
    components: {
      SelectTree
